...
export const metadata: Metadata = {
  title: "Disclaimer | Open SEO",
  description: "Disclaimer for Open SEO - Important information about our service",
};
      ...
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        ...
        <div className="prose prose-lg max-w-none space-y-8 text-gray-700">
          <section>
            ...
            <p>
              Open SEO uses artificial intelligence to generate blog articles. Please be aware that:
            </p>
          ...
          <section>
            ...
            <p>
              While Open SEO generates SEO-optimized content, we cannot guarantee:
            </p>
            <ul className="list-disc pl-6 space-y-2">
          ...
          <section>
            ...
            <p>
              Open SEO integrates with third-party services:
            </p>
            <ul className="list-disc pl-6 space-y-2">
            ...
            <p className="mt-4">
              You are responsible for complying with the terms of service of all third-party services you use through Open SEO.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              <strong>Important:</strong> Open SEO is free, but you pay directly to AI service providers for API usage.
            </p>
            <ul className="list-disc pl-6 space-y-2">
          ...
          <section>
            ...
            <p>
              While you retain ownership of content generated through Open SEO:
            </p>
            <ul className="list-disc pl-6 space-y-2">
          ...
          <section>
            ...
            <p>
              Open SEO is provided on an "as is" and "as available" basis. We do not guarantee:
            </p>
            <ul className="list-disc pl-6 space-y-2">
          ...
          <section>
            ...
            <p>
              Content generated by Open SEO is for informational purposes only and does not constitute:
            </p>
            <ul className="list-disc pl-6 space-y-2">
