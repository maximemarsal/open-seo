      ...
      <div className="relative z-10">
        ...
        <nav className="container mx-auto px-4 py-6 flex justify-between items-center">
          ...
          >
            ...
            />
            <span className="text-2xl font-bold text-gray-900">Open SEO</span>
            <span className="hidden md:inline-flex items-center gap-1 px-2 py-1 bg-emerald-100 text-emerald-700 text-xs font-medium rounded-full">
        ...
        <section className="container mx-auto px-4 py-16 md:py-24">
          ...
          >
            ...
            <p className="text-xl text-gray-600 mb-8">
              Join thousands of content creators using Open SEO to create
        ...
        <footer className="container mx-auto px-4 py-12 border-t border-gray-200">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-gray-600 text-center md:text-left">
              © 2025 Open SEO. Free & Open Source under MIT License.
            </p>
            </div>
